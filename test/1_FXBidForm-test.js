...
contract('FXBidForm', function(accounts) {
	it('Should be able to add a bid', async () => {
		await FXAuction.deployed().then(async function(fxBidForm) {
			await fxBidForm.submitBid(
				...
				let items = await fxBidForm.getAllPrimaryBids();
		...
		it('Should be able to get all submitted bids',  async () => {
			await FXAuction.deployed().then(async function(fxBidForm) {	
				let bids = await fxBidForm.getAllPrimaryBids();
				...
				bids = await fxBidForm.getAllPrimaryBids();
		...
		it('Should be able to get a submitted bid by id',  async () => {
			await FXAuction.deployed().then(async function(fxBidForm) {
				...
				let bid = await fxBidForm.findPrimaryBidById(1);
				console.log("---------------------BID------------->>>>>>>>>>>>>"+bid)
